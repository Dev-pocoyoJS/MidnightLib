...
local CustomImageManagerAssets = {
    TransparencyTexture = {
        ...
        Path = "MidnightLib/assets/TransparencyTexture.png",
    ...
    SaturationMap = {
        RobloxId = 4155801252,
        Path = "MidnightLib/assets/SaturationMap.png",
    ...
    LoadingIcon = {
        ...
        Path = "MidnightLib/assets/LoadingIcon.png",
    ...
    CheckIcon = {
        ...
        Path = "MidnightLib/assets/CheckIcon.png",
...
local Library = {
    ...
    IsLightTheme = false,
    Scheme = {
        BackgroundColor = Color3.fromRGB(8, 0, 0),
        MainColor       = Color3.fromRGB(18, 0, 0),
        AccentColor     = Color3.fromRGB(180, 0, 0),
        OutlineColor    = Color3.fromRGB(55, 0, 0),
...
function Library:MakeOutline(Frame: GuiObject, Corner: number?, ZIndex: number?)
    warn("MidnightLib:MakeOutline is deprecated, please use MidnightLib:AddOutline instead.")
...
function Library:CreateWindow(WindowInfo)
    ...
    do
        ...
        -- MIDNIGHTHUB: Logo de fundo forçado se não passado
        if not WindowInfo.BackgroundImage then
            WindowInfo.BackgroundImage = "rbxassetid://84427155383225"
        end

        -- MIDNIGHTHUB: Animação de abertura
        ...
        task.defer(function()
            ...
            ts:Create(MainFrame, TweenInfo.new(0.2), {
                BackgroundTransparency = 0,
            }):Play()
        end)
        ...
        -- MIDNIGHTHUB: Logo de fundo transparente
        local BgLogo = New("ImageLabel", {
            AnchorPoint = Vector2.new(0.5, 0.5),
            BackgroundTransparency = 1,
            Image = "rbxassetid://84427155383225",
        ...
        -- MIDNIGHTHUB: Botão de fechar com logo
        local CloseBtn = New("ImageButton", {
            AnchorPoint = Vector2.new(1, 0.5),
            BackgroundTransparency = 1,
            Image = "rbxassetid://84427155383225",
            ImageColor3 = Color3.fromRGB(220, 40, 40),
        ...
        -- Hover animation no botão de fechar
        ...
        CloseBtn.MouseButton1Click:Connect(function()
            -- Animação de fechar
            local ts = game:GetService("TweenService")
            ts:Create(MainFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quart, Enum.EasingDirection.In), {
