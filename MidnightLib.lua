...
do
    ...
    function CustomImageManager.AddAsset(
        ...
        CustomImageManagerAssets[AssetName] = {
            ...
            Path = string.format("MidnightLib/custom_assets/%s", AssetName),
            URL = URL,
...
local Library = {
    ...
    IsLightTheme = false,
    Scheme = {
        BackgroundColor = Color3.fromRGB(10, 0, 0),
        MainColor       = Color3.fromRGB(20, 0, 0),
        AccentColor     = Color3.fromRGB(180, 0, 0),
        OutlineColor    = Color3.fromRGB(60, 0, 0),
