...
function Library:AddDraggableButton(Text: string, Func, ExcludeScaling: boolean?)
    ...
    local isToggle = (Text == "Toggle")

    local Button
    if isToggle then
        -- MIDNIGHTHUB: Botão Toggle vira ImageButton com logo
    ...
    function Table:SetText(Text: string)
        if Button:IsA("ImageButton") then return end
...
function Library:CreateWindow(WindowInfo)
    ...
    -- MIDNIGHTHUB: Força fonte negrito independente do que o script passa
    Library.Scheme.Font = Font.new("rbxasset://fonts/families/GothamSSm.json", Enum.FontWeight.Bold)
    ...
    do
        ...
        -- MIDNIGHTHUB: Logo de fundo sempre visível
        local MHBgLogo = New("ImageLabel", {
            AnchorPoint = Vector2.new(0.5, 0.5),
            BackgroundTransparency = 1,
            Image = "rbxassetid://84427155383225",
